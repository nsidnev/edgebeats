...
#   `priv/edgedb/edgeql/accounts/update_public_settings.edgeql`.
defmodule LiveBeats.EdgeDB.Accounts.UpdatePublicSettings do
  @query """
  with updated_user := (
  ...
  @type keyword_args() :: [{:username, String.t()} | {:profile_tagline, String.t()}]

  @type map_args() :: %{
          username: String.t(),
          profile_tagline: String.t()
        }

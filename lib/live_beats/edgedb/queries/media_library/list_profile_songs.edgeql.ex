...
#   `priv/edgedb/edgeql/media_library/list_profile_songs.edgeql`.
defmodule LiveBeats.EdgeDB.MediaLibrary.ListProfileSongs do
  @query """
  select Song {
    *,
    mp3: {
  ...
  @type keyword_args() :: [{:user_id, uuid()} | {:limit, integer()}]
